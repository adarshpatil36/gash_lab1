...
public final class RequestServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<route.Chunk_requested,
      route.Chunk_response> getRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "request",
      requestType = route.Chunk_requested.class,
      responseType = route.Chunk_response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<route.Chunk_requested,
      route.Chunk_response> getRequestMethod() {
    io.grpc.MethodDescriptor<route.Chunk_requested, route.Chunk_response> getRequestMethod;
      ...
      synchronized (RequestServiceGrpc.class) {
        if ((getRequestMethod = RequestServiceGrpc.getRequestMethod) == null) {
          RequestServiceGrpc.getRequestMethod = getRequestMethod =
              io.grpc.MethodDescriptor.<route.Chunk_requested, route.Chunk_response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "request"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  route.Chunk_requested.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  route.Chunk_response.getDefaultInstance()))
  ...
  public static abstract class RequestServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void request(route.Chunk_requested request,
        io.grpc.stub.StreamObserver<route.Chunk_response> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                route.Chunk_requested,
                route.Chunk_response>(
  ...
  public static final class RequestServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RequestServiceBlockingStub> {
    ...
    /**
     */
    public route.Chunk_response request(route.Chunk_requested request) {
  ...
  public static final class RequestServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RequestServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<route.Chunk_response> request(
        route.Chunk_requested request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST:
          serviceImpl.request((route.Chunk_requested) request,
              (io.grpc.stub.StreamObserver<route.Chunk_response>) responseObserver);
          break;
        default:
  ...
  private static abstract class RequestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return route.Chunk.getDescriptor();
    }
